...
/**
	Ported from StringUtils.as.
	Changed so all methods are prototyped into string.
	Note: Some methods that are used within this class are static to StringUtils (with shortcuts from the prototyped methods);
*/
